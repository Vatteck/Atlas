...
URL_ENVIRONMENT_SETTINGS = f'https://raw.githubusercontent.com/Vatteck/atlas-files/master/web/env/v2/environment.yml'
DESKTOP_ENTRY_PATH_PATTERN = f'{DESKTOP_ENTRIES_DIR}/{__app_name__}.web.' + '{name}.desktop'
URL_FIX_PATTERN = "https://raw.githubusercontent.com/Vatteck/atlas-files/master/web/env/v2/fix/{domain}/{electron_branch}/fix.js"
URL_PROPS_PATTERN = "https://raw.githubusercontent.com/Vatteck/atlas-files/master/web/env/v2/fix/{domain}/{electron_branch}/properties"
