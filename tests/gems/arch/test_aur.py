...
class AURModuleTest(TestCase):
    ...
    def test_map_srcinfo__only_one_pkgname(self):
        expected_fields = {
            ...
            'source': ['https://github.com/Vatteck/Atlas/archive/0.9.6.tar.gz'],
        ...
        with open(FILE_DIR + '/resources/atlas_srcinfo') as f:
            srcinfo = f.read()

        res = aur.map_srcinfo(srcinfo, 'atlas')
    ...
    def test_map_srcinfo__one_name__only_specific_fields(self):
        ...
        res = aur.map_srcinfo(srcinfo, 'atlas', fields={*expected_fields.keys()})
